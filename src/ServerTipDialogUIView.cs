...
public class ServerTipDialogUIView : UIBase
{
	public delegate void VoidDelegateObj();

	public static ServerTipDialogUIView Instance;

	public ServerTipDialogUIView.VoidDelegateObj MaskAction;
	...
	private void Awake()
	{
		ServerTipDialogUIView.Instance = this;
