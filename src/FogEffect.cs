...
public class FogEffect : PostProcessBase
{
	...
	private string ScreenFogName = "ScreenFog";
	...
	private Texture2D Frost
	{
		get
		{
			ShaderEffectUtils.SafeCreateTexture(ref this.m_texFrost, this.ScreenFogName);
	...
	private Texture2D FrostNormals
	{
		get
		{
			if (this.m_texFrostNormals == null)
			{
	...
	{
		this.m_fFrostAmount = 0.42f;
		this.m_fEdgeSharpness = 0.97f;
		this.m_fMinFrost = 0f;
		this.m_fMaxFrost = 1f;
		this.m_fSeethroughness = 0.12f;
		this.m_fDistortion = 0f;
	}
