...
namespace LitJson
{
	public class JsonWriter
	{
		...
		public void Reset()
		{
			...
			if (this.inst_string_builder != null)
			{
				this.inst_string_builder.Remove(0, this.inst_string_builder.get_Length());
			}
		}
		...
		public void WritePropertyName(string property_name)
		{
			...
			if (this.pretty_print)
			{
				if (property_name.get_Length() > this.context.Padding)
				{
					this.context.Padding = property_name.get_Length();
				}
				for (int i = this.context.Padding - property_name.get_Length(); i >= 0; i--)
				{
					this.writer.Write(' ');
				}
				this.writer.Write(": ");
