...
namespace Package
{
	[ProtoContract(Name = "DBLuckDrawInfo")]
	[Serializable]
	public class DBLuckDrawInfo : IExtensible
	{
		private int _drawId;
		...
		private int _lastRefreshTime = -1;
		...
		[ProtoMember(5, IsRequired = false, Name = "lastRefreshTime", DataFormat = DataFormat.TwosComplement), DefaultValue(-1)]
