...
namespace Package
{
	...
	public class RoleAttrChangedNty : IExtensible
	{
		...
		public static readonly short OP = 768;

		private GameObjectType.ENUM _type;

		private long _id;

		private readonly List<RoleAttrChangedNty.AttrPair> _attrs = new List<RoleAttrChangedNty.AttrPair>();
		...
		public List<RoleAttrChangedNty.AttrPair> attrs
		{
			get
			{
				return this._attrs;
