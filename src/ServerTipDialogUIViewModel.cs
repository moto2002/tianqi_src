...
public class ServerTipDialogUIViewModel : ViewModelBase
{
	public class Names
	{
	...
	private static ServerTipDialogUIViewModel instance;
	...
	public static ServerTipDialogUIViewModel Instance
	{
		get
		{
			if (ServerTipDialogUIViewModel.instance == null)
			{
				ServerTipDialogUIViewModel.Open();
			}
			return ServerTipDialogUIViewModel.instance;
		}
	}
	...
	{
		UIManagerControl.Instance.OpenUI("ServerTipDialogUI", UINodesManager.T4RootOfSpecial, false, UIType.NonPush);
		ServerTipDialogUIView.Instance.SetSibling();
	}

	private void Close()
	{
		ServerTipDialogUIView.Instance.Show(false);
	}
}
