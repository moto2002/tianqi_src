...
namespace Package
{
	[ProtoContract(Name = "BattleAction_EndKnock")]
	[Serializable]
	public class BattleAction_EndKnock : IExtensible
	{
		...
		[ProtoMember(4, IsRequired = false, Name = "reason", DataFormat = DataFormat.TwosComplement), DefaultValue(0)]
		public int reason
		{
			get
			{
		...
		[ProtoMember(5, IsRequired = false, Name = "mgrSn", DataFormat = DataFormat.TwosComplement), DefaultValue(0)]
		public int mgrSn
		{
			get
			{
