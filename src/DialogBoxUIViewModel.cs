...
public class DialogBoxUIViewModel : ViewModelBase
{
	public class Names
	{
	...
	private static DialogBoxUIViewModel m_instance;
	...
	public static DialogBoxUIViewModel Instance
	{
		get
		{
			if (DialogBoxUIViewModel.m_instance == null)
			{
				DialogBoxUIViewModel.Open(null);
			}
			return DialogBoxUIViewModel.m_instance;
		}
	}
	...
	public void ShowAsOKCancel_as(string title, string content, Action actionShow, Action actionL, Action actionR, string nameL = "", string nameR = "", string btnL = "button_orange_1", string btnR = "button_yellow_1", Transform root = null)
	{
		...
		this.ShowAsOKCancel(title, content, actionL, actionR, nameL, nameR, btnL, btnR, root, true, true);
	}
	...
	{
		this.ShowAsOKCancel(title, string.Empty, actionL, actionR, "取 消", "确 定", "button_orange_1", "button_yellow_1", null, true, true);
	...
	{
		this.ShowAsOKCancel(title, string.Empty, actionL, actionR, "取 消", "确 定", "button_orange_1", "button_yellow_1", root, true, true);
	...
	private static void Open(Transform root = null)
	{
		...
		UIManagerControl.Instance.OpenUI("DialogBoxUI", root, false, UIType.NonPush);
		if (DialogBoxUIView.Instance != null)
		{
			DialogBoxUIView.Instance.SetSibling();
		}
	}
