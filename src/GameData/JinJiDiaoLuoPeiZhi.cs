...
namespace GameData
{
	[ProtoContract(Name = "JinJiDiaoLuoPeiZhi")]
	[Serializable]
	public class JinJiDiaoLuoPeiZhi : IExtensible
	{
		...
		private readonly List<JinJiDiaoLuoPeiZhi.DropPair> _drop = new List<JinJiDiaoLuoPeiZhi.DropPair>();
		...
		public List<JinJiDiaoLuoPeiZhi.DropPair> drop
		{
			get
			{
				return this._drop;
