...
public class GlobalReliveDialogUIView : UIBase
{
	public delegate void VoidDelegateObj();

	public static GlobalReliveDialogUIView Instance;

	public GlobalReliveDialogUIView.VoidDelegateObj MaskAction;
	...
	private void Awake()
	{
		GlobalReliveDialogUIView.Instance = this;
