...
public class FashionPreviewManager
{
	protected const string FashionPreviewCellName = "FashionPreviewCell";
	...
	protected static FashionPreviewManager instance;
	...
	public static FashionPreviewManager Instance
	{
		get
		{
			if (FashionPreviewManager.instance == null)
			{
				FashionPreviewManager.instance = new FashionPreviewManager();
			}
			return FashionPreviewManager.instance;
		}
	}

	protected FashionPreviewManager()
	{
	}
	...
	public FashionPreviewCell GetPreview(Transform root)
	{
		GameObject instantiate2Prefab = ResourceManager.GetInstantiate2Prefab("FashionPreviewCell");
		instantiate2Prefab.get_transform().SetParent(root, false);
		instantiate2Prefab.SetActive(true);
		return instantiate2Prefab.GetComponent<FashionPreviewCell>();
	}

	public void ReleasePreview(FashionPreviewCell fashionPreviewCell)
	{
		if (!fashionPreviewCell)
		{
			return;
		}
		this.ReturnPoolID(fashionPreviewCell.ModelIndex);
		fashionPreviewCell.ResetModelData();
	}
