...
public class GlobalReliveDialogUIViewModel : ViewModelBase
{
	public class Names
	{
	...
	private static GlobalReliveDialogUIViewModel instance;
	...
	public static GlobalReliveDialogUIViewModel Instance
	{
		get
		{
			if (GlobalReliveDialogUIViewModel.instance == null)
			{
				GlobalReliveDialogUIViewModel.Open();
			}
			return GlobalReliveDialogUIViewModel.instance;
		}
	}
	...
	{
		base.Awake();
		GlobalReliveDialogUIViewModel.instance = this;
	}
	...
	private static void Open()
	{
		...
		GlobalReliveDialogUIView.Instance.SetSibling();
	}

	private void Close()
	{
		GlobalReliveDialogUIView.Instance.Show(false);
	}
}
